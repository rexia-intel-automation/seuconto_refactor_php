...
<section class="animate-on-scroll" style="padding: 5rem 0;">
    <div class="container">
        <div class="gradient-primary" style="border-radius: var(--radius-xl); padding: 4rem 2rem; text-align: center; color: white; position: relative; overflow: hidden;">
            ...
            <a href="<?php echo url('pages/criar.php'); ?>" class="btn btn-lg" style="background: white; color: var(--color-primary); border-radius: 9999px; padding: 1.25rem 3rem; font-size: 1.25rem; position: relative; z-index: 1;">Criar Meu Conto →</a>
        </div>
    </div>
</section>
